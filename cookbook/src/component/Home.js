    ...
    <div
      ...
      <div className='row' style={{marginTop:100, marginBottom:100, width:'100%'}}>
        <div className='col s12'>
              <div className='col s3' style={{backgroundColor:'goldenrod',height:80,textAlign:'center',fontSize:35}}>
                <b><i>Our Recipes</i></b>
              </div>                
              <div className='col s9'>
                <div style={{backgroundColor:'gray',height:80,textAlign:'center',fontSize:35,marginLeft:"12%",marginRight:"6%"}}>
                <div
                  className="col s11" style={{padding:"1%"}}
                >
                 <form
        style={{
      ...
      >
                ...
                <div className='row' style={{position:"relative", left:0, top:0,marginLeft:"27%",marginRight:"6%"}}>
                {Array.isArray(activeRecipe) ? (activeRecipe.map((recipe, i) => {
